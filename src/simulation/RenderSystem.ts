...
export class RenderSystem {
    ...
    constructor(container: HTMLElement, mujoco: MujocoModule) {
        ...
        this.scene.background = new THREE.Color(0x1a1a1b); // Dark warehouse interior
        this.scene.fog = new THREE.FogExp2(0x1a1a1b, 0.15);
        ...
        // Isometric-like top-down view
        this.camera.position.set(1.8, -1.8, 2.2);
    ...
    initLights(dragStateManager: DragStateManager) {
        ...
        const fill = new THREE.DirectionalLight(0x99ccff, 0.6); 
        fill.position.set(-5, 2, 3); 
        this.simGroup.add(fill);

        // Warm accent light
        const accent = new THREE.PointLight(0xffaa44, 1.2, 10);
        accent.position.set(0, -2, 2);
        this.simGroup.add(accent);
